function [Image2d]=plot7_image_sst(numClass,data,i_ok,CLim,nomJour,L,La,Dim)
...
% ylabel('latitude')
% 
% h = title(['SST Classe ',num2str(numClass),' du ', nomJour(end-9:end)],'fontsize',12);
% set(h,'interpreter','none')
% 
% 
% FileName=[pwd, '/figures/classe_var/',nomJour,'/SST_Classe',num2str(numClass)];
