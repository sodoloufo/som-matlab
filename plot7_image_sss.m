function [Image2d]=plot7_image_sss(numClass,data,i_ok,CLim,nomJour,L,La,Dim)
...
% xlabel('longitude')
% ylabel('latitude')
% h = title(['SSS Classe ',num2str(numClass),' du ', nomJour(end-9:end)],'fontsize',12);
% set(h,'interpreter','none')
% 
% 
% FileName=[pwd, '/figures/classe_var/',nomJour,'/SSS_Classe',num2str(numClass)];
